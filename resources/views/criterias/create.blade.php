...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Kriteria Baru</h5>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('attribute') is-invalid @enderror" 
                            ...
                            <option value="cost" {{ old('attribute') == 'cost' ? 'selected' : '' }}>Cost (Semakin kecil semakin baik)</option>
                            <option value="benefit" {{ old('attribute') == 'benefit' ? 'selected' : '' }}>Benefit (Semakin besar semakin baik)</option>
                        </select>
                        @error('attribute')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
