                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('column_ref') is-invalid @enderror" 
                            ...
                            <option value="sugar" {{ old('column_ref', $criteria->column_ref) == 'sugar' ? 'selected' : '' }}>sugar (Gula)</option>
                            <option value="calories" {{ old('column_ref', $criteria->column_ref) == 'calories' ? 'selected' : '' }}>calories (Kalori)</option>
