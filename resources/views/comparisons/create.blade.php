...
<div class="container-fluid">
    <div class="mb-4">
        ...
        <h5 class="fw-bold">Buat Perbandingan Baru</h5>
    </div>
            ...
            <form action="{{ route('comparisons.store') }}" method="POST">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-check p-3 border rounded @error('drink_ids') border-danger @enderror" style="background: #f8f9fa;">
                                <input class="form-check-input" 
                                       ...
                                       value="{{ $drink->id }}" 
                                       id="drink_{{ $drink->id }}"
                                       {{ in_array($drink->id, old('drink_ids', [])) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              name="notes" 
                              rows="3" 
                              placeholder="Tambahkan catatan untuk perbandingan ini...">{{ old('notes') }}</textarea>
                </div>
